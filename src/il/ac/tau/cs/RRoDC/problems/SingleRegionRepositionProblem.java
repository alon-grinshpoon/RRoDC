...
public class SingleRegionRepositionProblem implements Problem {
	...
	private Solution placementProblemSolution;
	private int repositionConstraint;
	
	public SingleRegionRepositionProblem(Solution placementProblemSolution,
			int repositionConstraint) {
		this.placementProblemSolution = placementProblemSolution;
		this.repositionConstraint = repositionConstraint;
	}
	...
	public Solution solve() {
		...
		while(resources.getAmount() < Main.AVAILABLE_RESOURCES){
